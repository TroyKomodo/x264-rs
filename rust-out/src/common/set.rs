...
extern "C" {
    ...
    static x264_cqm_jvt4p: [uint8_t; 16];
    static x264_cqm_jvt8i: [uint8_t; 64];
    static x264_cqm_jvt8p: [uint8_t; 64];
...
static mut quant4_scale: [[uint16_t; 3]; 6] = [
    ...
    [
        7282 as libc::c_int as uint16_t,
...
static mut quant8_scale: [[uint16_t; 6]; 6] = [
    [
        13107 as libc::c_int as uint16_t,
        11428 as libc::c_int as uint16_t,
        20972 as libc::c_int as uint16_t,
        12222 as libc::c_int as uint16_t,
        16777 as libc::c_int as uint16_t,
        15481 as libc::c_int as uint16_t,
    ],
    [
        11916 as libc::c_int as uint16_t,
        10826 as libc::c_int as uint16_t,
        19174 as libc::c_int as uint16_t,
        11058 as libc::c_int as uint16_t,
        14980 as libc::c_int as uint16_t,
        14290 as libc::c_int as uint16_t,
    ],
    [
        10082 as libc::c_int as uint16_t,
        8943 as libc::c_int as uint16_t,
        15978 as libc::c_int as uint16_t,
        9675 as libc::c_int as uint16_t,
        12710 as libc::c_int as uint16_t,
        11985 as libc::c_int as uint16_t,
    ],
    [
        9362 as libc::c_int as uint16_t,
        8228 as libc::c_int as uint16_t,
        14913 as libc::c_int as uint16_t,
        8931 as libc::c_int as uint16_t,
        11984 as libc::c_int as uint16_t,
        11259 as libc::c_int as uint16_t,
    ],
    [
        8192 as libc::c_int as uint16_t,
        7346 as libc::c_int as uint16_t,
        13159 as libc::c_int as uint16_t,
        7740 as libc::c_int as uint16_t,
        10486 as libc::c_int as uint16_t,
        9777 as libc::c_int as uint16_t,
    ],
    [
        7282 as libc::c_int as uint16_t,
        6428 as libc::c_int as uint16_t,
        11570 as libc::c_int as uint16_t,
        6830 as libc::c_int as uint16_t,
...
pub unsafe extern "C" fn x264_8_cqm_init(mut h: *mut x264_t) -> libc::c_int {
    ...
    let mut min_qp_err: libc::c_int = 51 as libc::c_int
        + 6 as libc::c_int * (8 as libc::c_int - 8 as libc::c_int) + 18 as libc::c_int
        + 1 as libc::c_int;
    let mut num_8x8_lists: libc::c_int = if (*((*h).sps).as_mut_ptr())
        ...
        if j < i {
            ...
            (*h)
                ...
                (((51 as libc::c_int
                    ...
                    + 1 as libc::c_int) * size) as libc::c_ulong)
...
unsafe extern "C" fn cqm_parse_jmlist(
    ...
    if p.is_null() {
        memset(cqm as *mut libc::c_void, 16 as libc::c_int, length as libc::c_ulong);
        return 0 as libc::c_int;
    }
    ...
    let mut nextvar: *mut libc::c_char = strstr(
        p,
