...
pub unsafe extern "C" fn x264_split_options(
    ...
    loop {
        let mut length: size_t = strcspn(opt, b"=,\0" as *const u8 as *const libc::c_char);
        if *opt.offset(length as isize) as libc::c_int == '=' as i32 {
            ...
            length = (length as libc::c_ulong).wrapping_add(strcspn(
    ...
    let mut offset: size_t = ((2 as libc::c_int * (opt_count + 1 as libc::c_int)) as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong);
    size =
        size.wrapping_add(offset.wrapping_add(opt.offset_from(opt_str) as libc::c_long as size_t));
    let mut opts: *mut *mut libc::c_char =
        calloc(1 as libc::c_int as libc::c_ulong, size) as *mut *mut libc::c_char;
    if opts.is_null() {
        x264_cli_log(
            b"options\0" as *const u8 as *const libc::c_char,
            0 as libc::c_int,
    ...
    while i < 2 as libc::c_int * opt_count {
        let mut length_0: size_t = strcspn(opt_str, b"=,\0" as *const u8 as *const libc::c_char);
        if *opt_str.offset(length_0 as isize) as libc::c_int == '=' as i32 {
            ...
            *fresh2 = memcpy(
            ...
            opt_str = opt_str.offset(length_0.wrapping_add(1 as libc::c_int as size_t) as isize);
            length_0 = strcspn(opt_str, b",\0" as *const u8 as *const libc::c_char);
        } else {
            let mut option_0: *const libc::c_char =
                *options.offset((i / 2 as libc::c_int) as isize);
            ...
            *fresh4 = memcpy(
            ...
            offset = offset.wrapping_add(option_length.wrapping_add(1 as libc::c_int as size_t));
            option_0 =
                option_0.offset(option_length.wrapping_add(1 as libc::c_int as size_t) as isize);
        }
        let fresh5 = i;
        i += 1;
